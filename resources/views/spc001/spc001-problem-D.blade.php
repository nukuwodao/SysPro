<x-app-layout>
    <section class="t-section">
        ...
        <section class="c_body">
            ...
            <span>
                <h3>問題文</h3>
                <p>長さ$N$の値のわからない整数列$A$があります。</p>
                <p>長さ$N-1$の整数列$B$が与えられます。このとき、</p>
                <P>$B_i\le$$max(A_i,A_{i+1})$</P>
                <p>が成立することがわかっています。</p>
                <p>$A$の要素の総和として考えられる値の最大値を求めてください。</p>
            </span>
            <span>
                <h3>制約</h3>
                <ul class="constraint">
            ...
            <span>
                <h3>出力</h3>
                <p>$A$の要素の総和として考えられる値の最大値を出力せよ。</p>
            </span>
            <hr>
            <span clss="row">
                <div class="input-exe">
                ...
                <textarea placeholder="test" class="form-control col-xs-12 col-sm-8 col-md-8 col-lg-7" id="demo1" rows="2" readonly>3&NewLine;2 5</textarea>
            </span>
            <span clss="row">
                <div class="input-exe">
                    <h3>出力例 1</h3>
                </div>
                <textarea class="form-control col-xs-12 col-sm-8 col-md-8 col-lg-7" id="exampleFormControlTextarea1" rows="2" readonly>9</textarea>
                <p>$A$として、例えば$A=(2,1,5)$や、$A=(-1,-2,-3)$、$A=(2,2,5)$等が勧化られます。これらのうち$A$の要素の総和が最大となるものは、$A=(2,2,5)$です。</p>
            </span>
            <hr>
            <span clss="row">
                <div class="input-exe">
                ...
                <textarea class="form-control col-xs-12 col-sm-8 col-md-8 col-lg-7" id="demo2" rows="2" readonly>2&NewLine;3</textarea>
            </span>
            <span clss="row">
                <div class="input-exe">
                    <h3>出力例 2</h3>
                </div>
                <textarea class="form-control col-xs-12 col-sm-8 col-md-8 col-lg-7" id="exampleFormControlTextarea1" rows="2" readonly>6</textarea>
            </span>
            <hr>
            <span clss="row">
                <div class="input-exe">
                ...
                <textarea placeholder="test" class="form-control col-xs-12 col-sm-8 col-md-8 col-lg-7" id="demo3" rows="2" readonly>4&NewLine;0 153 10 10 23</textarea>
            </span>
            <span clss="row">
                <div class="input-exe">
                    <h3>出力例 3</h3>
                </div>
                <textarea class="form-control col-xs-12 col-sm-8 col-md-8 col-lg-7" id="exampleFormControlTextarea1" rows="2" readonly>53</textarea>
            </span>
            <hr>
            <span>
                <h3>提出</h3>
        ...
        <script type = "text/javascript">
            function func_submit(){
                const select = "D";
                const Problem_name = "D -Maximal Value-";
