<x-app-layout>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7" id="problem">
                        ...
                        <select name = "code" class="select2_01" id="submit_select">
                            <option value="A">A -Password-</option>
                            <option value="B">B -Social Distance-</option>
                            <option value="C">C -Buffet-</option>
                            <option value="D">D -Maximal Value-</option>
                            <option value="E">E -Rain Flows into Dams-</option>
    ...
    <script type = "text/javascript">
        function func_submit(){
            ...
            const Problem_select = $('#submit_select').select2('data');
            const Problem_name = Problem_select[0]['text'];
