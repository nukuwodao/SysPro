...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link id="jet-nav-link" href="{{ route('home') }}" :active="request()->routeIs('dashboard')">
                        {{ __('ホーム') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link id="jet-nav-link" href="<?php echo url('/contest'); ?>" :active="request()->routeIs('dashboard')">
                        {{ __('コンテスト一覧') }}
                    </x-jet-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div id="hamburger" class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="<?php echo url('/contest'); ?>" :active="request()->routeIs('dashboard')">
                {{ __('コンテスト一覧') }}
            </x-jet-responsive-nav-link>
        </div>

        <!-- Responsive Settings Options -->
        <div id="Gorilla" class="pt-4 pb-1 border-t border-gray-200">
